...
var style_V_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("V___");
    var labelText = "";
    size = 0;
    ...
    if (value >= 55.123700 && value <= 59.653460) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 59.653460 && value <= 61.131240) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 61.131240 && value <= 62.492060) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 62.492060 && value <= 64.738860) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 64.738860 && value <= 72.023000) {
            style = [ new ol.style.Style({
