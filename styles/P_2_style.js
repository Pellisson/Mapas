...
var style_P_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("P1_Solo_mg");
    var labelText = "";
    size = 0;
    ...
    if (value >= 27.900000 && value <= 37.859500) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 37.859500 && value <= 42.413680) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 42.413680 && value <= 46.159460) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 46.159460 && value <= 49.583880) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 49.583880 && value <= 63.100800) {
            style = [ new ol.style.Style({
